...
class DadosCadastroState extends State<DadosCadastro> {
  ...
  Future<String> _getDropDownCidade() async {
    var res = await http.get("http://179.190.40.41:443/api/cadastros/cidades/status/ATIVO");
    print(res.body);
    return res.body;
  }
  ...
  Future<String> _getDropDownEstado() async {
    var res = await http.get('http://179.190.40.41:443/api/cadastros/estados/status/ATIVO');
    print(res.body);
    return res.body;
  }
